...
{
    /// <inheritdoc />
    public partial class AddJobSeekerProfileSkillsAndCv : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalExperienceYears = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: false),
                    EducationLevel = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
